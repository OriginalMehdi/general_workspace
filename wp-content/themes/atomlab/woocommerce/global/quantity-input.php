...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity">
		<label class="screen-reader-text"
		       for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'atomlab' ); ?></label>
		...
		<input type="number" id="<?php echo esc_attr( $input_id ); ?>"
		       ...
		       aria-labelledby="<?php echo ! empty( $args['product_name'] ) ? sprintf( esc_attr__( '%s quantity', 'atomlab' ), $args['product_name'] ) : ''; ?>"
		/>
