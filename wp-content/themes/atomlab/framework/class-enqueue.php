...
if ( ! class_exists( 'Atomlab_Enqueue' ) ) {
	class Atomlab_Enqueue {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'waypoints', ATOMLAB_THEME_URI . '/assets/libs/waypoints/jquery.waypoints.min.js', array( 'jquery' ), ATOMLAB_THEME_VERSION, true );
			...
			if ( class_exists( 'WooCommerce' ) ) {
				...
				wp_enqueue_script( 'atomlab-woo', ATOMLAB_THEME_URI . "/assets/js/woo{$min}.js", array(
					'atomlab-script',
				), ATOMLAB_THEME_VERSION, true );
			}
